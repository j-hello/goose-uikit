...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Goose home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Goose home page" }, innerLogo))));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(Container$3, null, subLinks.map(function (entry) {
            var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
            return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
                React.createElement(MenuLink, { href: entry.href, onClick: handleClick },
                    React.createElement(LinkLabel, null, entry.label))));
    ...
    return (React.createElement(Container$4, null,
        ...
        React.createElement(SocialEntry, null,
            ...
            React.createElement(Flex, null, socials.map(function (social, index) {
                ...
                if (social.items) {
                    return (React.createElement(Dropdown, { key: social.label, position: "top", target: React.createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React.createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, color: "text" }, item.label)); })));
                }
...
var Menu = function (_a) {
    ...
    var _d = useState(true); _d[0]; var setShowMenu = _d[1];
