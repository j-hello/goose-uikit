...
var Icon$e = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 24" }, props),
        React.createElement("path", { d: "M19.2 3H5.19995C4.09995 3 3.19995 3.9 3.19995 5V19C3.19995 20.1 4.09995 21 5.19995 21H19.2C20.3 21 21.2 20.1 21.2 19V5C21.2 3.9 20.3 3 19.2 3ZM19.2 19H5.19995V5H19.2V19Z", fill: "#7342a7" }),
        React.createElement("path", { d: "M11.45 7.72021H6.44995V9.22022H11.45V7.72021Z", fill: "#7342a7" }),
        React.createElement("path", { d: "M18.2 15.75H13.2V17.25H18.2V15.75Z", fill: "#7342a7" }),
        React.createElement("path", { d: "M18.2 13.25H13.2V14.75H18.2V13.25Z", fill: "#7342a7" }),
        React.createElement("path", { d: "M8.19995 18H9.69995V16H11.7V14.5H9.69995V12.5H8.19995V14.5H6.19995V16H8.19995V18Z", fill: "#7342a7" }),
        React.createElement("path", { d: "M14.29 10.95L15.7 9.54L17.11 10.95L18.17 9.89L16.76 8.47L18.17 7.06L17.11 6L15.7 7.41L14.29 6L13.23 7.06L14.64 8.47L13.23 9.89L14.29 10.95Z", fill: "#7342a7" })));
};
...
var Icon$w = function (props) {
    return (React.createElement("img", __assign({ src: "/images/egg-icon.png", height: "329", width: "329", alt: "Egg token" }, props)));
};
...
var StyledButtonMenu$1 = styled.div(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  display: flex;\n  flex-wrap: wrap;\n\n  & > a,\n  & > button {\n    margin: 8.5px;\n    width: calc(50% - 17px);\n\n    ", " {\n      width: auto;\n      margin: 0;\n    }\n  }\n\n  & > button + button,\n  & > a + a {\n    margin-left: 8.5px;\n  }\n"], ["\n  display: flex;\n  flex-wrap: wrap;\n\n  & > a,\n  & > button {\n    margin: 8.5px;\n    width: calc(50% - 17px);\n\n    ", " {\n      width: auto;\n      margin: 0;\n    }\n  }\n\n  & > button + button,\n  & > a + a {\n    margin-left: 8.5px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
var ButtonMenuMulti = function (_a) {
    var _b = _a.activeIndex, activeIndex = _b === void 0 ? 0 : _b, _c = _a.size, size = _c === void 0 ? sizes.MD : _c, _d = _a.variant, variant = _d === void 0 ? variants.PRIMARY : _d, onClick = _a.onClick, children = _a.children;
    return (React.createElement(StyledButtonMenu$1, { variant: variant }, Children.map(children, function (child, index) {
        return cloneElement(child, {
            isActive: activeIndex === index,
            onClick: onClick ? function () { return onClick(index); } : undefined,
            size: size,
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "secondary", colorkey: variant === variants.PRIMARY ? "primary" : "textSubtle" }, props)));
    }
...
var style = (_a = {},
    ...
    _a);
var Heading = styled(Text)(templateObject_1$h || (templateObject_1$h = __makeTemplateObject(["\n  ", "\n  font-weight: ", ";\n  line-height: ", ";\n"], ["\n  ", "\n  font-weight: ", ";\n  line-height: ", ";\n"])), function (_a) {
    var size = _a.size;
...
var Link = function (_a) {
    ...
    var internalProps = external ? getExternalLinkProps() : {};
    return React.createElement(StyledLink, __assign({ as: "a" }, internalProps, props));
};
Link.defaultProps = {
    color: "primary",
    bold: false,
...
var Toggle = function (_a) {
    ...
    return (React.createElement(StyledToggle, { checked: isChecked, background: background },
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8.5px" },
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null, isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Goose home page" },
        React.createElement(Logo, { className: "desktop-icon" }))) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Goose home page" },
...
var LinkLabel = styled.div(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  margin-right: 12.75px;\n"], ["\n  margin-right: 12.75px;\n"])));
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        sub ? (React.createElement(SubMenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$8, { width: "12px" }) : React.createElement(Icon$7, { width: "12px" }))) : (React.createElement(MenuEntry, { onClick: handleClick, className: className },
            React.createElement(LinkLabel, null, label),
...
styled(Link)(templateObject_1$B || (templateObject_1$B = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ bold: true }, props),
        children,
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(Button, { size: "sm", variant: isMobile ? "tertiary" : "secondary", onClick: function () {
...
var Actions = styled.div(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n"], ["\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n"])));
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        isMobile && (React.createElement(Actions, null,
            ...
            React.createElement(UserBlock, { account: account, login: login, logout: logout, isMobile: true }))),
...
var Button$2 = styled.button(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  width: 33px;\n  height: 21px;\n  display: flex;\n  justify-content: space-between;\n  flex-direction: column;\n  border: 0;\n  background: none;\n  padding: 0;\n  cursor: pointer;\n\n  > span {\n    height: 3px;\n    background: var(--primary-color);\n    width: 100%;\n  }\n"], ["\n  width: 33px;\n  height: 21px;\n  display: flex;\n  justify-content: space-between;\n  flex-direction: column;\n  border: 0;\n  background: none;\n  padding: 0;\n  cursor: pointer;\n\n  > span {\n    height: 3px;\n    background: var(--primary-color);\n    width: 100%;\n  }\n"])));
...
var Menu = function (_a) {
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, cakePriceUsd: cakePriceUsd, pushNav: function () { return setIsPushed(false); }, links: links, priceLink: priceLink, account: account, login: login, logout: logout }),
